...
def compute_parallel(comparison, algorithm, reverse_complement=False):
...
def cli(fasta, directories, numThreads, compression, showProgress, output, reverse_complement):
    ...
    distances = tqdm_parallel_map(showProgress, executor, lambda x: compute_parallel(x, algorithm=compression, reverse_complement=reverse_complement), comparisons)
